...
import { gestionarExcepcionesMasivas, obtenerExcepcionesUsuario } from '../controllers/permisos.controller.js'
...
router.get('/excepciones/:id_us', verificarJWT, obtenerExcepcionesUsuario);
